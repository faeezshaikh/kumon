angular.module('starter.controllers')
	.controller('TestLevelsCtrl', function ($scope, $rootScope, $timeout, $ionicScrollDelegate, $stateParams, CardService, $window, $state, $location, $ionicModal) {

		console.log('Id = ', $stateParams.testTopicId);
		$scope.testTopic = $stateParams.testTopicId;
		// $scope.testTopics =
		// 	[	{"id":1, "topic": "Addition" },
